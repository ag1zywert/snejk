...
def main():
    ...
    window.title("WUNSZ") # window title
    ...
    class Snake: # snake class
        ...
        def draw(self):
            ...
            self.drawBox(self.food[0] * self.size, self.food[1] * self.size, color = 'black')
